...
export default function SystemStatusPage() {
  const { events, isGmailConnected, isClassroomConnected, isCalendarConnected } = useSimulationEngine()
  ...
  return (
    <PageContainer id="system-status-page">
      <div className="mb-8 flex justify-between items-start gap-8">
        <div>
          <h1
            className="text-[clamp(24px,3vw,36px)] font-bold text-[var(--color-text-primary)] font-orbitron uppercase tracking-wide leading-none flex items-center gap-3 mb-2"
          >
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
        ...
        <div className="xl:col-span-2">
          <SectionContainer title="Live System Events">
            <div className="intel-card p-0 overflow-hidden h-[500px] flex flex-col bg-[var(--color-bg-primary)]">
